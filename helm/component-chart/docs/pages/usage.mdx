...
```bash
helm upgrade --install my-component common-chart/component-chart --values values.yaml
```
...
Or from repository:
```bash
helm upgrade my-component common-chart/component-chart --values values.yaml
```
